"""
Ternary RSR v1.6 — two-pass: AVX2 permute then linear scan aggregate.

Pass 1: v_perm = v[perm] using AVX2 gather into aligned buffer.
Pass 2: sequential sum from contiguous v_perm (cache-friendly).
"""
...
_lib = ctypes.CDLL(os.path.join(_DIR, "rsr_ternary_v1_6.so"))
_lib.rsr_ternary_gemv_v1_6.restype = None
_lib.rsr_ternary_gemv_v1_6.argtypes = [
...
class RSRTernaryV1_6Multiplier(RSRTernaryV1_4Multiplier):
    """Ternary RSR v1.6: two-pass permute + linear scan, AVX2."""
