"""Ternary RSR v2.1: two-pass gather plus static scheduling."""
...
_lib = ctypes.CDLL(os.path.join(_DIR, "rsr_ternary_v2_1.so"))
_lib.rsr_ternary_gemv_v2_1.restype = None
_lib.rsr_ternary_gemv_v2_1.argtypes = [
...
class RSRTernaryV2_1Multiplier(RSRTernaryV1_4Multiplier):
    """Ternary RSR v2.1: two-pass gather and contiguous reduction."""
