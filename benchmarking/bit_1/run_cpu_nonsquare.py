"""
Benchmark inference time of non-square binary matrix-vector multiply.

Compares:
  - pytorch: dense torch matmul (baseline)
  - rsr_nonsquare: RSR v4.2 non-square multiplier
...
def main():
    ...
    for n_rows, n_cols in shapes:
        ...
        for k in k_values:
            try:
                m_rsr = RSRCppNonSquareMultiplier(M, k)
