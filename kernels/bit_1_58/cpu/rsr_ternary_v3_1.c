/*
 * RSR Ternary Inference Kernel v3.1
 *
 * Idea:
 *   - Keep the one-pass direct-gather structure from v2.0.
 *   - Shrink the hottest metadata arrays (perms and group_ends) to 16 bits.
 *   - Reduce Python overhead via cached ctypes pointers in the wrapper.
 */
