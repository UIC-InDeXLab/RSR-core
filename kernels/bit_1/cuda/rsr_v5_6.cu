/*
 * RSR CUDA kernel v5.6
 *
 * Packed group metadata (start, end, mask as int4), 256-thread blocks.
 * v5.7 adds sorted perms on top of this kernel.
 * v5.8 differs by using 1024 threads for k > 4.
 */
...
__global__ void rsr_gemv_v5_6_kernel(
...
void rsr_gemv_v5_6(
    ...
    rsr_gemv_v5_6_kernel<threads><<<num_blocks, threads, smem_bytes>>>(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("rsr_gemv_v5_6", &rsr_gemv_v5_6, "RSR GEMV CUDA v5.6");
